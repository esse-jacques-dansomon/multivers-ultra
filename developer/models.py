...
class Developer(models.Model):
    ...
    email = models.EmailField(max_length=255, unique=True, null=False, help_text="Email du développeur", verbose_name="Email")
    ...
    country = models.ForeignKey(Country, on_delete=models.CASCADE, verbose_name="Pays", related_name='developers', related_query_name='developer')
    # Files ...
    cv = models.FileField(upload_to='developers/cvs/%Y/%m/%d/', max_length=255, null=False, help_text="CV du développeur")
    photo = models.ImageField(upload_to='developers/photos/%Y/%m/%d/', max_length=255,  null=False, help_text="Photo du développeur")
    video = models.FileField(upload_to='developers/videos/%Y/%m/%d/', max_length=255,  blank=True,null=True, help_text="Video du développeur")

    whatsApp = models.CharField(max_length=255, unique=True, blank=True,null=True, help_text="WhatsApp du développeur", verbose_name="WhatsApp")
    ...
    linkedin = models.URLField(max_length=255, unique=True, blank=True,null=True, help_text="LinkedIn du développeur", verbose_name="LinkedIn")
    instagram = models.URLField(max_length=255,  unique=True,blank=True,null=True, help_text="Instagram du développeur")
    ...
    bitbucket = models.URLField(max_length=255,unique=True,  blank=True,null=True, help_text="BitBucket du développeur")
    website = models.URLField(max_length=255,unique=True,  blank=True,null=True, help_text="Site web du développeur", verbose_name="Site web")
    ...
    availability = models.TextField( null=False, blank=True, help_text="Disponibilité du développeur", verbose_name="Disponibilité")
    modeReglement = models.CharField(max_length=255, blank=True,  null=False, help_text="Mode de règlement du développeur", verbose_name="Mode de règlement")
    bankAccount = models.CharField(max_length=255,  blank=True, null=False, help_text="Compte bancaire du développeur", verbose_name="Compte bancaire")
    created_at = models.DateTimeField(auto_now_add=True,  blank=True,null=True, editable=False, verbose_name="Date de création")
    updated_at = models.DateTimeField(auto_now=True,  blank=True,null=True, auto_created=True, verbose_name="Date de modification")
...
class DeveloperSkill(models.Model):
    ...
    skill = models.ForeignKey(Skill, on_delete=models.CASCADE, related_name='developer_skills', verbose_name="Competence")
